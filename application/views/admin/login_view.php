...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/admin/assets/css/custom.css" rel="stylesheet" />
     <!-- GOOGLE FONTS-->
   <link href='<?php echo base_url() ?>assets/admin/http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
                            ...
                            <div class="panel-body">
                              ...
                              ?>
                                <form role="form" method="post" action="<?php echo base_url('login') ?>">
                                    ...
                                    <hr />
                                    Home Page ? <a href="<?php echo base_url() ?>" >click disini </a> 
                                    </form>
                            </div>
